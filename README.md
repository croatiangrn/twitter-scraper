...
[![Go Reference](https://pkg.go.dev/badge/github.com/croatiangrn/twitter-scraper.svg)](https://pkg.go.dev/github.com/croatiangrn/twitter-scraper)
...
```shell
go get -u github.com/croatiangrn/twitter-scraper
```
...
import (
    "context"
    "fmt"
    twitterscraper "github.com/croatiangrn/twitter-scraper"
)
